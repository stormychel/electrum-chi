...
These scripts can be used for cross-compilation of Windows Electrum-NMC executables from Linux/Wine.
...
[that script](https://github.com/namecoin/electrum-nmc/blob/master/.travis.yml) might help.
