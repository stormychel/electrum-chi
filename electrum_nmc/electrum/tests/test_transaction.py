...
class TestTransaction(ElectrumTestCase):
    ...
    def test_tx_unsigned(self):
        expected = {
            'inputs': [{
                'type': 'p2pkh',
                'address': frombtc('1446oU3z268EeFgfcwJv6X2VBXHfoYxfuD'),
                'num_sig': 1,
            ...
            'lockTime': 0,
            'outputs': [{
                'address': frombtc('14CHYaaByjJZpx4oHBpfDMdqhTyXnZ3kVs'),
                'prevout_n': 0,
        ...
        self.assertEqual(tx.get_outputs_for_UI(), [TxOutputForUI(frombtc('14CHYaaByjJZpx4oHBpfDMdqhTyXnZ3kVs'), 1000000)])

        self.assertTrue(tx.has_address(frombtc('14CHYaaByjJZpx4oHBpfDMdqhTyXnZ3kVs')))
        self.assertTrue(tx.has_address(frombtc('1446oU3z268EeFgfcwJv6X2VBXHfoYxfuD')))
        self.assertFalse(tx.has_address(frombtc('1CQj15y1N7LDHp7wTt28eoD1QhHgFgxECH')))
    ...
    def test_parse_xpub(self):
        ...
        self.assertEqual(res, ('04ee98d63800824486a1cf5b4376f2f574d86e0a3009a6448105703453f3368e8e1d8d090aaecdd626a45cc49876709a3bbb6dc96a4311b3cac03e225df5f63dfc', frombtc('19h943e4diLc68GXW7G75QNe2KWuMu7BaJ')))
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual((ADDR, frombtc('bc1qw508d6qejxtdg4y5r3zarvary0c5xw7kv8f3t4')), addr_from_script('0014751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual((ADDR, frombtc('bc1pw508d6qejxtdg4y5r3zarvary0c5xw7kw508d6qejxtdg4y5r3zarvary0c5xw7k7grplx')), addr_from_script('5128751e76e8199196d454941c45d1b3a323f1433bd6751e76e8199196d454941c45d1b3a323f1433bd6'))
        self.assertEqual((ADDR, frombtc('bc1sw50qa3jx3s')), addr_from_script('6002751e'))
        self.assertEqual((ADDR, frombtc('bc1zw508d6qejxtdg4y5r3zarvaryvg6kdaj')), addr_from_script('5210751e76e8199196d454941c45d1b3a323'))
        ...
        # base58 p2pkh
        self.assertEqual((ADDR, frombtc('14gcRovpkCoGkCNBivQBvw7eso7eiNAbxG')), addr_from_script('76a91428662c67561b95c79d2257d2a93d9d151c977e9188ac'))
        self.assertEqual((ADDR, frombtc('1BEqfzh4Y3zzLosfGhw1AsqbEKVW6e1qHv')), addr_from_script('76a914704f4b81cadb7bf7e68c08cd3657220f680f863c88ac'))
        # almost but not quite
        ...
        # base58 p2sh
        self.assertEqual((ADDR, frombtc('35ZqQJcBQMZ1rsv8aSuJ2wkC7ohUCQMJbT')), addr_from_script('a9142a84cf00d47f699ee7bbc1dea5ec1bdecb4ac15487'))
        self.assertEqual((ADDR, frombtc('3PyjzJ3im7f7bcV724GR57edKDqoZvH7Ji')), addr_from_script('a914f47c8954e421031ad04ecd8e7752c9479206b9d387'))
        # almost but not quite
