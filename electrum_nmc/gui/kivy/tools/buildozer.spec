...
source.exclude_dirs = bin, build, dist, contrib,
    electrum_nmc/tests,
    electrum_nmc/gui/qt,
    electrum_nmc/gui/kivy/tools,
    electrum_nmc/gui/kivy/theming/light
...
presplash.filename = %(source.dir)s/electrum_nmc/gui/icons/electrum_presplash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/electrum_nmc/gui/icons/electrum_launcher.png
